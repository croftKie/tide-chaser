...
export const waveHeightIcon = (waveHeight) => {
  ...
  switch (boardSize) {
    case "5":
      selectedClass =
        waveHeight < 0.65 ? "red" : waveHeight < 1.6 ? "orange" : "green";
      break;
    case "6":
      selectedClass =
        waveHeight < 0.6 ? "red" : waveHeight < 1.5 ? "orange" : "green";
      break;
    case "7":
      selectedClass =
        waveHeight < 0.5 ? "red" : waveHeight < 1.4 ? "orange" : "green";
      break;
    case "8":
      selectedClass =
        waveHeight < 0.5 ? "red" : waveHeight < 1.3 ? "orange" : "green";
      break;
    case "9":
      selectedClass =
        waveHeight < 0.4 ? "red" : waveHeight < 1.1 ? "orange" : "green";
      break;
  }
...
export const windSpeedIcon = (windSpeed) => {
  const selectedClass =
    windSpeed < 5 ? "green" : windSpeed < 15 ? "orange" : "red";
  return selectedClass;
};
