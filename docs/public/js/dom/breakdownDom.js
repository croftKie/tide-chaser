...
function surfHTML(
  ...
  return `
    <div class="surf upper-surf-data" id="surfing">
        ...
        <div>
            <img class="wave-height-icon ${waveHeightIcon}" src="./public/assets/wave-height.png" alt="">
        ...
        <div>
            <img class="wind-direction-icon ${windDirecIcon}" src="./public/assets/wind-direction.png" alt="">
            <p class="wind-direction">${windDirec}</p>
        </div>
        <div>
            <img class="wind-speed-icon ${windSpeedIcon}" src="./public/assets/wind-speed.png" alt="">
...
function weatherHTML(
  ...
  return `
    <div class="temp-data">
        <div>
            <img class="air-temp-icon ${airTempIcon}" src="./public/assets/temperature.png" alt="">
            <p class="air-temperature">${temp}°C</p>
        </div>  
        <div>
            <img class="water-temp-icon ${waterTempIcon}" src="./public/assets/water-temperature.png" alt="">
