...
export function initMenu(){
    settingsOpen.addEventListener("click",()=>{
        ...
        document.querySelector(".removeData").addEventListener("click",(e)=>{
            localStorage.removeItem(e.target.attributes[1].value);
            populateFavourites();
        });
    });
